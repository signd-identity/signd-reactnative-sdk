...
typedef NS_ENUM(NSInteger, RGLDocReaderAction) {
    /**
     Processing is finished, results are received
     */
    RGLDocReaderActionComplete = 0,
    /**
     Processing is not finished, intermediate results can be received
     */
    ...
    /**
     Processing is canceled, incomplete results can be received
     */
    RGLDocReaderActionCancel = 3,
    /**
     Processing is finished with an error, incomplete results can be received
     */
...
/**
 It's used for single frame processing
