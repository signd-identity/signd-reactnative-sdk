...
#ifndef SIGNDSCANIDACUANT_SWIFT_H
#define SIGNDSCANIDACUANT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SigndScanIdAcuant",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_PROTOCOL("_TtP17SigndScanIdAcuant19AutoCaptureDelegate_")
...
SWIFT_PROTOCOL("_TtP17SigndScanIdAcuant21CameraCaptureDelegate_")
...
SWIFT_CLASS("_TtC17SigndScanIdAcuant23CameraCornerOverlayView")
...
SWIFT_CLASS("_TtC17SigndScanIdAcuant25CameraDocumentOverlayView")
...
SWIFT_CLASS("_TtC17SigndScanIdAcuant13CameraOptions")
...
@property (nonatomic, readonly) CGColorRef _Nonnull colorReposition;
...
SWIFT_CLASS("_TtC17SigndScanIdAcuant16CaptureConstants")
...
SWIFT_CLASS("_TtC17SigndScanIdAcuant24DocumentCameraController")
...
- (BOOL)isDocumentMovedWithPoints:(NSArray<NSValue *> * _Nonnull)points SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP17SigndScanIdAcuant21FrameAnalysisDelegate_")
...
@interface DocumentCameraController (SWIFT_EXTENSION(SigndScanIdAcuant)) <FrameAnalysisDelegate>
- (void)onFrameAvailableWithFrameResult:(enum FrameResult)frameResult points:(NSArray<NSValue *> * _Nullable)points;
@end


SWIFT_PROTOCOL("_TtP17SigndScanIdAcuant23DocumentCaptureDelegate_")
...
@interface DocumentCameraController (SWIFT_EXTENSION(SigndScanIdAcuant)) <DocumentCaptureDelegate>
- (void)readyToCapture;
- (void)documentCapturedWithImage:(UIImage * _Nonnull)image barcodeString:(NSString * _Nullable)barcodeString;
@end


@interface DocumentCameraController (SWIFT_EXTENSION(SigndScanIdAcuant)) <AutoCaptureDelegate>
- (BOOL)getAutoCapture SWIFT_WARN_UNUSED_RESULT;
- (void)setAutoCaptureWithAutoCapture:(BOOL)autoCapture;
@end
...
SWIFT_CLASS("_TtC17SigndScanIdAcuant22DocumentCaptureSession")
@interface DocumentCaptureSession : AVCaptureSession
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@interface DocumentCaptureSession (SWIFT_EXTENSION(SigndScanIdAcuant)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
@interface DocumentCaptureSession (SWIFT_EXTENSION(SigndScanIdAcuant)) <AVCaptureMetadataOutputObjectsDelegate>
...
@interface DocumentCaptureSession (SWIFT_EXTENSION(SigndScanIdAcuant)) <AVCapturePhotoCaptureDelegate>
