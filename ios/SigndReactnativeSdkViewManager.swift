// SigndReactnativeSdkViewManager.swift

@objc(SigndReactnativeSdkViewManager)
class SigndReactnativeSdkViewManager: NSObject {
    ...
    @objc func initialize(_ data:(NSDictionary)*data
        ...
        let showBackButton = data["showBackButton"] ?? false
